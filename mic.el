...
;; This package is yet another `use-package' and `leaf', but is also used with them (See [[
...
;; There are some functions to define your own `mic'. See [[
;;
;;; How to Use?
...
;;       (define-key dired-mode-map (kbd "M-q")
;;
;;     ;; `:hook'
